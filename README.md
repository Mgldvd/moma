...
| Visual | `moma-sub-title` | Print a rule-first secondary title. |
...
| Visual | `moma-resume` | Print a titled, colored content block. |
| Visual | `moma-divider` | Print a marker-led horizontal rule. |
...
| Interactive | `moma-prompt` | Read a free-text answer. |
...
Every image below is a real screenshot of the actual `moma` executable
running in a pseudo-terminal, generated by
[`screenshots/`](screenshots/README.md) - not a hand-drawn mockup.

#### `moma-header`

<img src="./.img/moma-header.png" width="700" alt="moma-header preview">

#### `moma-title`

<img src="./.img/moma-title.png" width="700" alt="moma-title preview">

#### `moma-title-sub`

<img src="./.img/moma-title-sub.png" width="700" alt="moma-title-sub preview">

#### `moma-sub-title`

<img src="./.img/moma-sub-title.png" width="700" alt="moma-sub-title preview">

#### `moma-section`

<img src="./.img/moma-section.png" width="700" alt="moma-section preview">

#### `moma-msg`

<img src="./.img/moma-msg.png" width="700" alt="moma-msg preview">

#### `moma-msg-simple`

<img src="./.img/moma-msg-simple.png" width="700" alt="moma-msg-simple preview">

#### `moma-list`

<img src="./.img/moma-list.png" width="700" alt="moma-list preview">

#### `moma-box`

<img src="./.img/moma-box.png" width="700" alt="moma-box preview">

#### `moma-resume`

<img src="./.img/moma-resume.png" width="700" alt="moma-resume preview">

#### `moma-divider`

<img src="./.img/moma-divider.png" width="700" alt="moma-divider preview">

#### `moma-label`

<img src="./.img/moma-label.png" width="700" alt="moma-label preview">

#### `moma-input`

<img src="./.img/moma-input.png" width="700" alt="moma-input preview">

#### `moma-prompt`

<img src="./.img/moma-prompt.png" width="700" alt="moma-prompt preview">

#### `moma-select` / `moma-single-select`

<img src="./.img/moma-single-select.png" width="700" alt="moma-single-select preview">

#### `moma-single-select-groups`

<img src="./.img/moma-single-select-groups.png" width="700" alt="moma-single-select-groups preview">

#### `moma-multi-select`

<img src="./.img/moma-multi-select.png" width="700" alt="moma-multi-select preview">

#### `moma-multi-select-groups`

<img src="./.img/moma-multi-select-groups.png" width="700" alt="moma-multi-select-groups preview">

#### `moma-rabbit`

<img src="./.img/moma-rabbit.png" width="700" alt="moma-rabbit preview">

#### `moma-confirm`

<img src="./.img/moma-confirm.png" width="700" alt="moma-confirm preview">

#### `moma-spinner`

<img src="./.img/moma-spinner.png" width="700" alt="moma-spinner preview">

#### `moma-command-check`

<img src="./.img/moma-command-check.png" width="700" alt="moma-command-check preview">

#### `moma-version`

<img src="./.img/moma-version.png" width="700" alt="moma-version preview">
