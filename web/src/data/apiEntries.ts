...
export const API_ENTRIES: ApiEntryData[] = [
  ...
  },
  {
    ...
    signature: 'moma resume --title "<text>" [--item "term" "description"]... [--text "line"]... [--success|--error|--warning|--info] [--color color] [--no-color]',
    searchText: 'moma-resume resume block by blocks definition list term description column grouped section color item text',
    group: 'visual',
    examples: [
    ...
    options: [
      ...
      { flag: '--success | --error | --warning | --info', description: "Sets only the block's border/title color to the semantic color - this component never shows an icon." },
