...
export const FUNCTION_ROWS: FunctionRowData[] = [
  {
    ...
    signature: 'moma title | title-sub | sub-title | section | msg | msg-simple | list | box | resume | prompt | label | input | select | single-select | single-select-groups | multi-select | multi-select-groups | rabbit',
  },
  {
